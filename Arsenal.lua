...
local r = q.CreateLib("Darkrai X | Arsenal | Open Source Version","Serpent")
						  ...
						  then 
							  O.Value = 20
							   ...
							   then 
                                ...
                                G:NewButton("CARCKED BY Ash#0947", "CARCKED BY Ash#0947", function()
											print("CARCKED BY Ash#0947")
															  end)
